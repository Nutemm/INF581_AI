...
class FlappyBird(base.PyGameWrapper):
    ...
    def getGameState(self):
        ...
        state = {
            ...
            "previous_pipe_dist_to_player": -200 if not previous_pipe else previous_pipe.x - self.player.pos_x,
            "previous_pipe_top_y": 20 if not previous_pipe else previous_pipe.gap_start,
            "previous_pipe_bottom_y": (20 if not previous_pipe else previous_pipe.gap_start) + self.pipe_gap
        }
